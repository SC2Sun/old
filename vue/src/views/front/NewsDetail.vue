  ...
  <div class="main-content" style="width: 60%">
    <div class="card">
      ...
      <div style="color: #666; text-align: center">
        ...
        <span>浏览量：<span style="color: #ea0101">{{ news.count }}</span></span>
      </div>
      <hr style="margin: 20px 0; border: none; border-bottom: 1px solid #ccc; width: 80%; margin-left: auto; margin-right: auto;">
