<template>
  <div class="main-content">
    ...
    <div style="display: flex; width: 70%; margin: 30px auto ;font-size: 20px; margin-bottom: 20px">我报名的活动</div>

    <div style="display: flex; width: 70%; margin: 30px auto" class="table">
