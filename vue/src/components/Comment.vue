  ...
  <div>
    <div class="card" style="margin: 10px 0">
      ...
      <div style="margin-bottom: 20px">
        <el-input type="textarea" placeholder="请输入评论" v-model="form.content"></el-input>
      ...
      <div>
        <div v-for="item in commentList" :key="item.id" style="display: flex; grid-gap: 15px; margin-bottom: 20px">
          <img :src="item.avatar" alt="" style="width: 50px; height: 50px; border-radius: 30%/70%">
          <div style="flex: 1;">
            ...
            <div v-if="item.children.length">
              <div v-for="sub in item.children" :key="sub.id" style="display: flex; grid-gap: 15px; margin-bottom: 10px">
                <img :src="sub.avatar" alt="" style="width: 50px; height: 50px; border-radius: 30%/70%">
                <div style="flex: 1;">
